    ...
    <div className="bg-dark text-light min-h-screen">
      ...
      <section className="py-12 md:py-20 px-4 md:px-24 w-full bg-gradient-to-b from-primary to-secondary">
        <div className="">
          <h2 className="text-3xl md:text-5xl mb-8 md:mb-16 text-center font-Garet bg-clip-text text-transparent bg-gradient-to-r from-light to-accent animate-fadeIn py-2">
            Recupera tu tiempo y reduce el estrés
          </h2>
        </div>
          ...
          {[
            {
              ...
              icon: <FiEye className="w-12 h-12 md:w-24 md:h-24" />,
              color: "from-purple-light to-accent",
            },
            {
              title: "Sin IA ni plagios",
              desc: "Nos enfocamos en la calidad de tus resultados y no en el uso de IA.",
              icon: <FiShield className="w-12 h-12 md:w-24 md:h-24" />,
              color: "from-accent to-purple-dark",
            },
            {
              title: "Comunicación constante",
              desc: "Mantenemos un diálogo abierto para asegurar que cada etapa del proyecto cumpla con tus expectativas.",
              icon: <FiMessageCircle className="w-12 h-12 md:w-24 md:h-24" />,
              color: "from-purple-dark to-secondary",
            },
            {
              title: "Éxito garantizado",
              desc: "Te brindamos un proceso de trabajo que garantiza calidad, originalidad y cumplimiento de plazos.",
              icon: <FiBookOpen className="w-12 h-12 md:w-24 md:h-24" />,
            ...
            >
              <div className="mb-4 md:mb-6 flex justify-center">
                <div className="p-4 md:p-6 bg-light/10 rounded-full backdrop-blur-sm">
                  {service.icon}
                </div>
              </div>
              <h3 className="text-lg md:text-3xl font-Poppins-Medium mb-2 md:mb-4 text-center">
                {service.title}
              </h3>
              <p className="text-light/80 text-xs md:text-xl text-center font-Poppins-Medium">
                {service.desc}
              </p>
            </div>
          ))}
      ...
      <section className="py-12 md:py-24 bg-gradient-to-b from-primary to-purple-dark relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
          <div
            className="absolute top-20 left-10 w-20 md:w-32 h-20 md:h-32 rounded-full bg-accent animate-float"
            style={{ animationDelay: "0.5s" }}
          ></div>
          <div
            className="absolute bottom-40 right-10 md:right-20 w-32 md:w-48 h-32 md:h-48 rounded-full bg-purple-light animate-float"
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8 md:gap-12">
            <div className="text-center lg:text-left max-w-2xl">
              ...
              <p
                className="text-light/90 text-base md:text-lg font-Poppins-Medium mb-6 md:mb-8 animate-fadeIn"
                style={{ animationDelay: "0.3s" }}
              >
                Cada número representa una historia de éxito y un proyecto
                entregado con excelencia.
              </p>

              <div
                className="bg-secondary/50 border border-accent/30 rounded-xl p-4 md:p-6 backdrop-blur-md animate-fadeInUp"
                style={{ animationDelay: "0.6s" }}
              >
                <p className="text-light/80 font-Poppins-Medium text-sm md:text-base">
                  "La calidad no es un acto, es un hábito que cultivamos en cada
                  proyecto."
                </p>
              </div>
            </div>
            ...
            <div
              className="grid grid-cols-2 gap-4 md:gap-8 w-full max-w-2xl animate-fadeIn"
            ...
            >
              {[
                ...
                >
                  <span
                    className={`text-2xl md:text-5xl text-${stat.color_text} font-bold block mb-1 md:mb-2 text-dark`}
                  >
                    <Counter value={stat.number} duration={2} />+
                  </span>
                  <span
                    className={`text-xs md:text-sm font-Poppins-Medium text-${stat.color_text}`}
                  >
                    {stat.label}
                  </span>
                </div>
      ...
      <section className="w-full min-h-[50vh] md:min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-dark-blue to-primary relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
          ...
          <div
            className="absolute bottom-1/4 right-1/3 w-24 md:w-48 h-24 md:h-48 rounded-full bg-purple-light/30 blur-3xl animate-pulse-glow"
        ...
        <div className="text-center px-4 md:px-6 relative">
          ...
          <p className="text-base md:text-xl mb-8 md:mb-12 text-light/80 mx-auto font-Poppins-Medium">
