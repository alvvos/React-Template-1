                    ...
                    >
                        ...
                        >
                            {reviews?.map((review, i) => (
                                ...
                                >
                                    <div className="group relative aspect-video overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 bg-white">
                                        <Review
                                            texto={review.texto}
                                        ...
                                        <div className="absolute inset-0 bg-gradient-to-t from-dark/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                                            <span className="text-base md:text-xl font-Poppins-Medium opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-500 bg-black/50 px-4 py-2 rounded-full backdrop-blur-sm text-white">
                                                Ver proyectos
                                            </span>
                                        </div>
